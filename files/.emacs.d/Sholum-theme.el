...
(custom-theme-set-faces
 ...
 '(custom-button ((((class color) (min-colors 16777215)) (:background "#5D8272" :foreground "#e6e6e8" :box (:line-width 2 :color "#5D8272" :style none) :height 0.9)) (((class color) (min-colors 255)) (:background "#5D8272" :foreground "#e6e6e8" :box (:line-width 2 :color "#5D8272" :style none) :height 0.9)) (t (:background "#5D8272" :foreground "#e6e6e8" :box (:line-width 2 :color "#5D8272" :style none) :height 0.9))))
 '(custom-button-mouse ((((class color) (min-colors 16777215)) (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#eed891" :style none))) (((class color) (min-colors 255)) (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#eed891" :style none))) (t (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#eed891" :style none)))))
 '(custom-button-pressed ((((class color) (min-colors 16777215)) (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#545c5e" :style none))) (((class color) (min-colors 255)) (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#545c5e" :style none))) (t (:inherit custom-button :foreground "#eed891" :box (:line-width 2 :color "#545c5e" :style none)))))
